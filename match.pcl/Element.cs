...
namespace match
{
	...
	class Element
    {
        ...
        static void StartSwapAnimation (Element first, Element clicked)
        {
            ...
            Debug.WriteLine (String.Format ("Selected point coords:{0} {1}", first.getXcoord (), first.getYcoord ()));
            Debug.WriteLine (String.Format ("Selected point coords:{0} {1}", clicked.getXcoord (), clicked.getYcoord ()));
            ...
            Debug.WriteLine (String.Format ("Center of rotation is {0} {1}", first.rotationCenter.xCoord, first.rotationCenter.yCoord));
